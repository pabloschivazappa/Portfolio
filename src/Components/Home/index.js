...
const Home = () => {
    return(
        <section id="home" className={styles.home}>
            <div className={styles.homeText} data-aos="fade-down">
                <strong>Hello, it's me</strong>
                <h1>Pablo Schivazappa</h1>
                <p>Full stack developer with a background in photography. After over a decade working as photographer and videographer I came to the conclusion that it was time to take it a leap further and become a full time web developer.
            ...
            <div className={styles.homeImg} data-aos="flip-right">
